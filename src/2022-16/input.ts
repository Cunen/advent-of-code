export const testInput = `Valve AA has flow rate=0; tunnels lead to valves DD, II, BB
...
export const prodInput = `Valve XG has flow rate=0; tunnels lead to valves CR, OH
